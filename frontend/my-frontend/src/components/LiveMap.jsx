...
const LiveMap = ({ initialLocation, activeCaseId }) => {
    ...
    useEffect(() => {
        if (caseId && socket) {
            ...
            // Re-join implicitly if websocket drops and connects back magically over spotty data
            ...
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    if (lastLat === latitude && lastLng === longitude) {
                        return; // Ignore duplicate coordinates exactly as generated by device sensor
                    }
